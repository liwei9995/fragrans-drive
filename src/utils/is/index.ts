...
export const is = (val: unknown, type: string) =>
  objToString.call(val) === `[object ${type}]`
 ...
 */
export const isAsyncFunction = <T = unknown>(val: unknown): val is Promise<T> =>
...
export const isMobileByUA = () =>
  isWindow(window) && /Mobi|Android|iPhone/i.test(navigator?.userAgent)

export const isMobileByOrientation = () =>
  isWindow(window) && typeof window.orientation !== 'undefined'

export const isMobileByTouchEvent = () =>
  isWindow(window) && 'ontouchstart' in document.documentElement

export const isMobile = () =>
  isMobileByUA() || isMobileByOrientation() || isMobileByTouchEvent()

// 是否为图片节点
export const isImageDom = (o: Element) =>
  o && ['IMAGE', 'IMG'].includes(o.tagName)
